...
axiosClient.interceptors.response.use(
  ...
  (error) => {
    ...
    if (isTemporaryProfileFailure) {
      try { sessionStorage.setItem("chalin03_session_warning", errorMessage || "Fresh profile details could not be loaded. Your verified session remains active."); } catch { /* sessionStorage may be unavailable */ }
