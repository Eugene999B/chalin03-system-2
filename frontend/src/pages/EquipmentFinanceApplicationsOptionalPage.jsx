  ...
  return (
    <div className="finance-optional-approval-shell">
      <div className="finance-simple__notice is-info" role="status">
        ...
        affordability, guarantor, consent or document fields are recorded as optional. This does
        not block submission or approval by an authorised manager or administrator.
