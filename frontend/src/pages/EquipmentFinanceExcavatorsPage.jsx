      ...
      <section className="excavator-registration-modal" role="dialog" aria-modal="true" aria-labelledby="excavator-registration-title" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <form id="excavator-registration-form" className="excavator-registration-modal__body" onSubmit={onSave}>
          <div className="excavator-registration-modal__grid">
            ...
            <ModalField title="Engine number (Optional)"><input value={form.engine_number} onChange={(event) => onValue("engine_number", event.target.value)} /></ModalField>
            <ModalField title="Registration / number plate (Optional)"><input value={form.registration_number} onChange={(event) => onValue("registration_number", event.target.value)} /></ModalField>
            ...
            <ModalField title="Current meter (Optional)"><input type="number" min="0" step="0.01" value={form.current_meter} onChange={(event) => onValue("current_meter", event.target.value)} /></ModalField>
            ...
            <ModalField title="Acquisition cost (Optional)" hint={form.acquisition_cost ? money(form.acquisition_cost) : "Not provided"}><input inputMode="decimal" value={form.acquisition_cost} onChange={(event) => onValue("acquisition_cost", event.target.value.replace(/[^0-9.,]/g, ""))} /></ModalField>
            <ModalField title="Acquisition date (Optional)"><input type="date" value={form.acquisition_date} onChange={(event) => onValue("acquisition_date", event.target.value)} /></ModalField>
            ...
            <ModalField title="Customer reference (Optional)"><input value={form.acquisition_reference} onChange={(event) => onValue("acquisition_reference", event.target.value)} /></ModalField>
            ...
            <ModalField title="Title document reference (Optional)"><input value={form.title_document_reference} onChange={(event) => onValue("title_document_reference", event.target.value)} /></ModalField>
            <ModalField title="Insurance reference (Optional)"><input value={form.insurance_reference} onChange={(event) => onValue("insurance_reference", event.target.value)} /></ModalField>
