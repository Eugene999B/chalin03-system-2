...
import EquipmentFinanceCompanyWideLifecyclePage from "./EquipmentFinanceCompanyWideLifecyclePage";
...
export default function EquipmentSalesWorkspacePage() {
  ...
  if (FINAL_LIFECYCLE_STAGES.has(stage)) return <EquipmentFinanceCompanyWideLifecyclePage />;
