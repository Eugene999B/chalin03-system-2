...
const helpContent = {
  ...
  equipment_hire: {
    ...
    sections: [
      ...
      ["13. Maintenance, reports and shared documents", "Use the Maintenance Register for inspections, service history, meters and defects. Use Sales Documents & Reports, Hire Reports, shared controls and notifications for the correct location and period. Automatic rule refresh raises overdue invoice, ending-contract, pending-approval, draft-work-log and open-damage alerts. Protect customer, finance and machine records.", ["Review maintenance status", "Confirm report filters", "Protect exported files"]],
