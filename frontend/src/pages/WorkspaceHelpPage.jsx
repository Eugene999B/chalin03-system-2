...
const helpContent = {
  mining: {
    ...
    sections: [
      ...
      ["10. Reports, notifications and shared controls", "Use Mining reports, shared documents, notifications and audit evidence for the selected site and period. Confirm filters before exporting and keep operational, staff and contractor information private.", ["Confirm site and dates", "Review notifications", "Protect exported records"]],
      ...
      ["12. Security, passwords and support", "Use password-only sign-in, least-privilege permissions and controlled corrections. Review Activity Log evidence and notify the System Administrator before repeating a failed sensitive action. Never share passwords, OTPs, private files or production backup data.", ["Keep your password private", "Escalate unusual errors", "Do not bypass permissions"]],
    ],
  },
  equipment_hire: {
    icon: "🏗️",
    ...
    sections: [
      ...
      ["13. Maintenance, reports and shared documents", "Use the Maintenance Register for inspections, service history, meters and defects. Use Sales Documents & Reports, Hire Reports, shared controls and notifications for the correct location and period. Protect customer, finance and machine records.", ["Review maintenance status", "Confirm report filters", "Protect exported files"]],
      ["14. Workers, employment documents, signatures and security", "Equipment Sales & Hire workers, permissions and private files are category-isolated. Employment documents may use the protected boss signature after review and approval. Use password-only sign-in, least privilege and Activity Log evidence, and report unexpected failures before retrying a sensitive action.", ["Use the correct workforce", "Review documents before approval", "Never share passwords or private files"]],
    ],
  },
};
