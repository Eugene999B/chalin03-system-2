...
-- Snapshot current settings into agreements that have never had a commercial
-- policy snapshot. We intentionally mark these as legacy-review rather than
-- silently asserting that today's policy was their historical contract.
