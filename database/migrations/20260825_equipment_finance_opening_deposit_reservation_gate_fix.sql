...
-- Reset-safe refinement of the exact-machine reservation gate.
-- This replaces only the reservation trigger and preserves the approved
-- Phase 4 payment and commitment controls.
