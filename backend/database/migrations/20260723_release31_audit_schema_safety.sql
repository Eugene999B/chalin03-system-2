...
-- Moves audit table creation, column repair and index repair out of normal HTTP requests.
...
CALL chalin03_release31_audit_add_column(
    'audit_signoffs',
    'branch_id',
...
CALL chalin03_release31_audit_add_index(
    'audit_signoffs',
