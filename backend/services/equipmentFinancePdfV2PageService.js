...
function drawWatermark(doc, document) {
  ...
  drawOfficialLogo(doc, centreX - 145, centreY - 150, 290, 290, 0.038);

  doc.save();
  doc.strokeColor(template.accent).opacity(0.035).lineWidth(1.8);
  ...
  doc.font("Times-Bold").fontSize(template.family === "certificate" ? 52 : 39);
