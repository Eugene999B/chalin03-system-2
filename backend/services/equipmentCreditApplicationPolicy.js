...
function evaluateCreditApplication(input = {}, kyc = {}) {
  ...
  if (kycStatus === "incomplete") {
    riskScore += 30;
    reasons.push("Required customer identity, consent or guarantor information is incomplete.");
  ...
  let recommendation = "Eligible within the standard internal affordability policy.";
